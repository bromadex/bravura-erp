...
import { LeaveProvider }              from './contexts/LeaveContext'   // ✅ Tier 2
...
import LeaveBalance    from './pages/HR/LeaveBalance'   // ✅ Tier 2
  ...
  return (
    <Routes>
      ...
      <Route path="/module/hr" element={
        ...
        <Route path="leave-balance" element={<LeaveBalance />} />  {/* ✅ Tier 2 */}
...
// ───────────────────────────────────────────────────────────────
//
// ✅ LeaveProvider sits at root level inside PermissionProvider.
// One shared cache instance serves ALL modules:
//   HR (Leave.jsx, LeaveBalance.jsx, Employees.jsx)
//   Inventory (StockOut.jsx)
//   Fuel (FuelIssuance.jsx)
// No need to wrap individual module routes separately.
