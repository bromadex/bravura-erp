...
const MODULE_PAGES = {
  ...
  assets:      ['dashboard','registry','reclass-log','import','category-config'],
...
const ALL_MODULES = [
  ...
  { id: 'assets',      icon: 'inventory_2',         label: 'Asset Registry',     color: '#b83232', desc: 'Unified asset management', route: '/module/assets',      moduleName: 'assets'      },
