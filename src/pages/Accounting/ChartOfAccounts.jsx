...
export default function ChartOfAccounts() {
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      {/* Filters */}
      <div className="btn-group" style={{ marginBottom: 14, flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <table className="table">
            ...
            <tbody>
              {loading ? (
                ...
                <tr key={a.id}>
                  <td className="td-mono" style={{ color: TYPE_COLOR[a.type] }}>{a.code}</td>
                  ...
                  <td className="td-mono">{fmt(a.balance)}</td>
      ...
      {/* Add/Edit modal */}
      <ModalDialog open={modal} onClose={() => { setModal(false); setEditing(null) }} title={`${editing ? 'Edit' : 'Add'} Account`}>
