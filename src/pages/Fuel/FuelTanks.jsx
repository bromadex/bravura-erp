  ...
  return (
    <div>
      ...
      <div className="table-wrap">
        <table>
          <thead>
            <tr><th>Name</th><th>Capacity (L)</th><th>Current Level (L)</th><th>Fuel Type</th><th>Alert Threshold</th><th>Location</th><th></th></tr>
          </thead>
          <tbody>
            {loading ? <tr><td colSpan="7">Loading...<\/td><\/tr> : tanks.length === 0 ? <tr><td colSpan="7">No tanks<\/td><\/tr> : tanks.map(t => (
              <tr key={t.id}>
