  ...
  return (
    <div>
      ...
      <div className="table-wrap">
        <table>
          <thead>
            <tr><th>Date</th><th>Tank</th><th>Type</th><th>Quantity (L)</th><th>Unit Cost</th><th>Total Value</th><th>Supplier</th><th>Dip Before (L)</th><th>Dip After (L)</th><th>Notes</th></tr>
          </thead>
          <tbody>
            {loading ? <tr><td colSpan="10">Loading...<\/td><\/tr> : deliveries.length === 0 ? <tr><td colSpan="10">No deliveries<\/td><\/tr> : deliveries.map(d => {
