...
export default function PurchaseOrders() {
  ...
  const handleReceive = (poId) => {
    // This will open GRN modal – in a full implementation, trigger GRN creation
    toast.info('Receive goods – GRN creation will open here')
  }
                  ...
                  <tr key={po.id}>
                    ...
                    <td>
                      {canEdit && po.status !== 'completed' && (
                        <button className="btn btn-secondary btn-sm" onClick={() => handleReceive(po.id)}>
