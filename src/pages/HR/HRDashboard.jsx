...
const CATEGORIES = [
  ...
  },
  {
    ...
    icon: 'payments',
    label: 'Payroll',
    desc: 'Salary structures, payroll & timesheets',
    color: '#a78bfa',
    route: '/module/hr/payroll',
    pages: ['payroll', 'timesheet', 'salary-structures', 'travel'],
  },
  {
    id: 'recruitment',
    icon: 'work_outline',
    label: 'Recruitment',
    desc: 'Job openings, applicants & interviews',
    color: '#06b6d4',
    route: '/module/hr/job-postings',
    pages: ['job-postings', 'applicants', 'interviews'],
  },
  {
    id: 'performance',
    icon: 'rate_review',
    label: 'Performance',
    desc: 'Appraisals, goals & KPI reviews',
    color: '#f59e0b',
    route: '/module/hr/appraisal-periods',
    pages: ['appraisal-periods', 'performance-reviews', 'kpi-templates'],
  },
  {
    id: 'expenses',
    icon: 'receipt_long',
