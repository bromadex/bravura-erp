...
// ✅ Tier 2: added leave-balance to HR Time & Attendance section
    ...
    sections: [
      ...
      },
      {
        ...
        pages: [
          ...
          { id: 'leave-balance', label: 'Leave Balance', icon: 'account_balance_wallet' }, // ✅ Tier 2
        ],
      },
      {
        label: 'Travel',
  ...
  return (
    <>
      ...
      {mobileOpen && (
        ...
        >
          <div onClick={e => e.stopPropagation()} style={{ height: '100vh' }}>
            {sidebarContent}
          </div>
